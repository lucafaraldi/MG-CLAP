...
- Command: `table_1_zero_shot/continual_mgclap.py --backbone laion --fold all --seed 0 --tasks 10 --classes-per-task 5 --alpha 0.1 --adapter-rank 8 --epochs-max 20 --lr 1e-3 --weight-decay 1e-4 --batch-size 64 --betas 4 --class-order canonical --out-dir /tmp/mgclap_phase2/alpha_rank/alpha_0p10__rank_08`
- Backbone: `laion`
- Folds: `[1, 2, 3, 4, 5]`
...
|---|---:|---:|---:|---:|---:|---:|
| mgc_only | 4.0 | 1 | 0.8184 | 0.7600 | 0.2528 | 6 |
| mgc_only | 4.0 | 2 | 0.7992 | 0.7375 | 0.2833 | 6 |
| mgc_only | 4.0 | 3 | 0.8256 | 0.7975 | 0.2139 | 6 |
| mgc_only | 4.0 | 4 | 0.8115 | 0.7525 | 0.2611 | 6 |
| mgc_only | 4.0 | 5 | 0.7702 | 0.7375 | 0.2806 | 6 |
| mgp_mgc | 4.0 | 1 | 0.9455 | 0.9200 | 0.0722 | 6 |
| mgp_mgc | 4.0 | 2 | 0.9578 | 0.9150 | 0.0861 | 6 |
| mgp_mgc | 4.0 | 3 | 0.9637 | 0.9250 | 0.0778 | 6 |
| mgp_mgc | 4.0 | 4 | 0.9495 | 0.8850 | 0.1028 | 6 |
| mgp_mgc | 4.0 | 5 | 0.9288 | 0.8775 | 0.1167 | 6 |
| mgp_only | 0.0 | 1 | 0.8217 | 0.8100 | 0.1889 | 6 |
| mgp_only | 0.0 | 2 | 0.8108 | 0.7850 | 0.2083 | 6 |
| mgp_only | 0.0 | 3 | 0.8418 | 0.8325 | 0.1556 | 6 |
| mgp_only | 0.0 | 4 | 0.8487 | 0.8150 | 0.1806 | 6 |
| mgp_only | 0.0 | 5 | 0.8157 | 0.8175 | 0.1583 | 6 |
| naive_adapter | 0.0 | 1 | 0.7609 | 0.6525 | 0.3750 | 6 |
| naive_adapter | 0.0 | 2 | 0.7325 | 0.5900 | 0.4472 | 6 |
| naive_adapter | 0.0 | 3 | 0.7808 | 0.7225 | 0.2944 | 6 |
| naive_adapter | 0.0 | 4 | 0.7757 | 0.6950 | 0.3194 | 6 |
| naive_adapter | 0.0 | 5 | 0.7454 | 0.6675 | 0.3528 | 6 |
