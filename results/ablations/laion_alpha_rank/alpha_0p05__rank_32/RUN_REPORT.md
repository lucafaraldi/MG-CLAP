...
- Command: `table_1_zero_shot/continual_mgclap.py --backbone laion --fold all --seed 0 --tasks 10 --classes-per-task 5 --alpha 0.05 --adapter-rank 32 --epochs-max 20 --lr 1e-3 --weight-decay 1e-4 --batch-size 64 --betas 4 --class-order canonical --out-dir /tmp/mgclap_phase2/alpha_rank/alpha_0p05__rank_32`
- Backbone: `laion`
- Folds: `[1, 2, 3, 4, 5]`
...
| mgc_only | 4.0 | 3 | 0.7546 | 0.7350 | 0.2833 | 3 |
| mgc_only | 4.0 | 4 | 0.7272 | 0.6825 | 0.3361 | 3 |
| mgc_only | 4.0 | 5 | 0.7099 | 0.6475 | 0.3861 | 3 |
| mgp_mgc | 4.0 | 1 | 0.9465 | 0.9250 | 0.0667 | 3 |
| mgp_mgc | 4.0 | 2 | 0.9654 | 0.9250 | 0.0750 | 3 |
| mgp_mgc | 4.0 | 3 | 0.9680 | 0.9350 | 0.0611 | 3 |
| mgp_mgc | 4.0 | 4 | 0.9545 | 0.9075 | 0.0778 | 3 |
| mgp_mgc | 4.0 | 5 | 0.9344 | 0.8750 | 0.1194 | 3 |
| mgp_only | 0.0 | 1 | 0.8229 | 0.8325 | 0.1611 | 3 |
| mgp_only | 0.0 | 2 | 0.8161 | 0.7825 | 0.2139 | 3 |
| mgp_only | 0.0 | 3 | 0.8396 | 0.8225 | 0.1667 | 3 |
| mgp_only | 0.0 | 4 | 0.8440 | 0.8000 | 0.1917 | 3 |
| mgp_only | 0.0 | 5 | 0.8165 | 0.7950 | 0.1861 | 3 |
...
| naive_adapter | 0.0 | 4 | 0.7051 | 0.6450 | 0.3778 | 3 |
| naive_adapter | 0.0 | 5 | 0.6810 | 0.5500 | 0.4972 | 3 |
