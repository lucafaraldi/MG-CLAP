...
- Command: `table_1_zero_shot/continual_mgclap.py --backbone laion --fold all --seed 0 --tasks 10 --classes-per-task 5 --alpha 0.3 --adapter-rank 4 --epochs-max 20 --lr 1e-3 --weight-decay 1e-4 --batch-size 64 --betas 4 --class-order canonical --out-dir /tmp/mgclap_phase2/alpha_rank/alpha_0p30__rank_04`
- Backbone: `laion`
- Folds: `[1, 2, 3, 4, 5]`
...
|---|---:|---:|---:|---:|---:|---:|
| mgc_only | 4.0 | 1 | 0.8575 | 0.8150 | 0.1889 | 14 |
| mgc_only | 4.0 | 2 | 0.8255 | 0.7125 | 0.3111 | 14 |
| mgc_only | 4.0 | 3 | 0.8600 | 0.7950 | 0.2194 | 15 |
| mgc_only | 4.0 | 4 | 0.8396 | 0.7475 | 0.2611 | 15 |
| mgc_only | 4.0 | 5 | 0.8174 | 0.7350 | 0.2806 | 14 |
| mgp_mgc | 4.0 | 1 | 0.8864 | 0.8325 | 0.1694 | 14 |
| mgp_mgc | 4.0 | 2 | 0.9013 | 0.8625 | 0.1389 | 14 |
| mgp_mgc | 4.0 | 3 | 0.8866 | 0.8250 | 0.1806 | 15 |
| mgp_mgc | 4.0 | 4 | 0.8892 | 0.7825 | 0.2222 | 15 |
| mgp_mgc | 4.0 | 5 | 0.8830 | 0.8425 | 0.1556 | 14 |
| mgp_only | 0.0 | 1 | 0.7970 | 0.7100 | 0.3056 | 14 |
| mgp_only | 0.0 | 2 | 0.7915 | 0.7025 | 0.3083 | 14 |
| mgp_only | 0.0 | 3 | 0.8213 | 0.7800 | 0.2222 | 15 |
| mgp_only | 0.0 | 4 | 0.8185 | 0.7625 | 0.2361 | 15 |
| mgp_only | 0.0 | 5 | 0.8043 | 0.7600 | 0.2333 | 14 |
| naive_adapter | 0.0 | 1 | 0.7889 | 0.7100 | 0.3056 | 14 |
| naive_adapter | 0.0 | 2 | 0.7669 | 0.6625 | 0.3667 | 14 |
| naive_adapter | 0.0 | 3 | 0.7961 | 0.7250 | 0.2806 | 15 |
| naive_adapter | 0.0 | 4 | 0.7917 | 0.7075 | 0.3000 | 15 |
| naive_adapter | 0.0 | 5 | 0.7671 | 0.6800 | 0.3361 | 14 |
| zero_shot_clap | 0.0 | 1 | 0.8187 | 0.8425 | 0.0389 | 14 |
| zero_shot_clap | 0.0 | 2 | 0.8184 | 0.8200 | 0.0556 | 14 |
| zero_shot_clap | 0.0 | 3 | 0.8197 | 0.8275 | 0.0472 | 15 |
| zero_shot_clap | 0.0 | 4 | 0.8094 | 0.8375 | 0.0306 | 15 |
| zero_shot_clap | 0.0 | 5 | 0.8217 | 0.8275 | 0.0500 | 14 |
